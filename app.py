...
user_menu=st.sidebar.radio(
    'Choose one option',
    ('Medal-wise Tally','Overall Analysis','Country-wise Tally','Athlete-wise Analysis')
)

if user_menu == 'Medal-wise Tally':
...
if user_menu=="Overall Analysis":
    ...
    x=helper.most_successfull_athletes(df,selected_sport)
    st.table(x)
...
if user_menu=="Country-wise Tally":
    ...
    top10_df=helper.most_successfull_countrywise_athletes(df,selected_country)
    st.table(top10_df)
